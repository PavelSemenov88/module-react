...
const Form = ({ link, linkText, title, btnText, handleClick, setErrorMess,errorMessPass }) => {
      ...
      <form autoComplete='on' className="auth__form">
        ...
        <div className="form">
          ...
          <input
            ...
            placeholder="email"
          />
          <p className="form__error">{errorMessEmail}</p>
          ...
          />
          <p className="form__error">{errorMessPass}</p>
          ...
          <p className="form__error">{setErrorMess}</p>
