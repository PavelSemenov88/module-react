...
const Form = ({ link, linkText, title, btnText, handleClick, errorMess, errorMessLog, setErrorMessLength }) => {
      ...
      <form autoComplete='on' className="auth__form">
        ...
        <div className="form">
          ...
          <input
            ...
            placeholder="email"
          />
          <p className="form__error form__error_posi">{errorMessLog} {setErrorMessLength}</p>
