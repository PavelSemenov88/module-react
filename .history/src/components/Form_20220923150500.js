...
const Form = ({ link, linkText, title, btnText, handleClick, errorMess, errorMessLog,  }) => {
      ...
      <form autoComplete='on' className="auth__form">
        ...
        <div className="form">
          ...
          <input
            ...
            placeholder="email"
          />
          <p className="form__error">{errorMessLog}</p>
          ...
          />
          <p className="form__error form__error_posh">{errorMessLog}</p>
